...
![Screenshot of the CRAN page for the vsp package](vsp-cran.png){fig-alt="Screenshot of the CRAN package page for 'vsp', showing the title, version, and links to the Github repository for bug reports."}
