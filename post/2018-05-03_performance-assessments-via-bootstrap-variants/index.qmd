...
[^4]: Cross validation is much less stable than the bootstrap on data sets with fewer than 20,000 data points (@steyerberg2001). Frank Harrell has run a number of simulations showing that you need at least 100 repetitions of 10-fold cross-validation to get accurate error estimates at this data size (@harrell2015).
