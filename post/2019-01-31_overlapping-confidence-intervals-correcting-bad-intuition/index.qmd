...
[^covariance]: This is actually a bad example because OLS estimates for regression coefficients are correlated. A better example would be plotting confidence intervals for independent groups means like you get from classic cross-sectional experimental designs.
