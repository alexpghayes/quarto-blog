...
it is frankly impossible to look at the current state of applied work and to find yourself anywhere other than having epistemic trust issues.
...
## Statisticians resent being seen as useless and helpful, especially when methodological errors in applied work are so common, but an institutional level have not 
...
Let me state frankly: the content in statistical service courses is, by and large, a criminal abomination and a horrifying embarassment

## Despite... ambivalence about service, statisticians expect to be treated as experts in data analysis


"statisticians have been doing data science all along"
[benn stancil]
...
## Methodology is primarily a social problem, not a technical problem
...
- OSU consulting obligation for teure review; senior statistician listed off the "good statisticians" in the department, and they weren't the people doing applied work
...
::: {.callout-note}
While I generalize extensively in this post, academia is large and highly varied. I have done my best to characterize the parts of the academy that I am familiar with, but this post is almost certainly subject to some myopia due to my own limited experience.
:::
